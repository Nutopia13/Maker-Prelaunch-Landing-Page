  ...
  return (
    <div className='mt-[64px] lg:flex lg:justify-center hero_bg lg:min-h-[470px]'>
      ...
      <div className={`${styles.paddingX}text_cont flex flex-row flex-wrap justify-center text-center mt-[48px] min-w-[327px] max-w-[600px]`}>
        <h1 className={`${styles.heading1} mb-[23px] max-w-[250px] lg:max-w-[700px]`}>Get paid for the work you <span>love</span> to do.</h1>
        <p className={`${styles.paragraph} lg:max-w-[540px] mb-[32px]`}>The 9-5 grind is so last century. We believe in living life on your own terms. Whether you’re looking to escape the rat race or set up a side hustle, we’ve got you covered.</p>
