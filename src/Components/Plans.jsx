      ...
      <div className='px-7 '>
        ...
        <div className='mt-[70px] lg:gap-[30px] flex justify-center flex-row flex-wrap'>
          <div className="cart_dip text-left bg-plain-blue rounded-lg	">
            ...
            <h3 className='text-extra-bold mt-[26px]  lg:px-[38px] pl-[30px] text-2xl font-manrope mb-[19px] text-white'>Free</h3>
          ...
          <img src={paid} alt="" className='pl-[30px] pb-[10px] relative bottom-8'/>
            ...
            <h3 className='price text-primary-bg text-extra-bold  lg:px-[38px] mt-[26px] pl-[30px] text-2xl font-manrope mb-[19px]'>$25.00</h3>
